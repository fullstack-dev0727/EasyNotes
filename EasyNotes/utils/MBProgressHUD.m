...
- (void)showMessage:(NSString*) message doneImage:(BOOL) doneImage{
    [self show:YES];
    self.labelText = message;
    
    if (doneImage == YES) {
        self.customView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"checkmark.png"]] autorelease];
        self.mode = MBProgressHUDModeCustomView;
    }
    else{
        self.customView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"nil"]] autorelease];
        self.mode = MBProgressHUDModeCustomView;
    }
